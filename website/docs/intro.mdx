...
Diagon is a state-management library focused on letting you safely write code in vanilla JavaScript or TypeScript in a mutable style just like you learned in school. You now do not have to copy your entire state tree when you want to increment a single value.  
...
## The Dark Side of Immmutability
