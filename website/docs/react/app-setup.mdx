...
## Create State a Subscription Context

First, you simply initialize your state.  You may use reacts useState hook or define your state globablly.  It's up to you. 

At the top level of your app, you need a [`SubscriptionContext`](subscription-context.mdx) provider that will enable support for all of Diagon's hooks.

That provider is initialized with [`useSubscriptionContextValue`](use-subscription-context-value.mdx) which holds your root state and tracks object subscriptions in your app. 
