...
Accesses the topmost state that you gave to the [`SubscriptionContext`](/react/subscription-context.mdx) via [`useSubscriptionContextValue`](/react/use-subscription-context-value.mdx). 
...
The root state that was given to the [`SubscriptionContext`](/react/subscription-context.mdx) via [`useSubscriptionContextValue`](/react/use-subscription-context-value.mdx). 
