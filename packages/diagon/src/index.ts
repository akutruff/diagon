export { areSame, asOriginal, clearModified, commitPatches, createRecordingProxy, currentContext, Diagon, doNotTrack, ensureProxy, getCurrentPatch, getPatchSource, isProxy, makePatchRecorder, recordPatches, resetEnvironment, tryGetProxy } from './diagon';
